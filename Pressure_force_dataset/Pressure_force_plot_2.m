...
scatter(curved_plate_20mm_data.weight_reading_1/1000*9.81, curved_plate_20mm_data.pressure_reading_1, 15, 'o', 'MarkerEdgeColor', '#77AC30')
hold on
scatter(curved_plate_30mm_data.weight_reading_1/1000*9.81, curved_plate_30mm_data.pressure_reading_1, 15, 'o', 'MarkerEdgeColor', '#EDB120')
hold on
...
hold on
scatter(curved_plate_50mm_data.weight_reading_1/1000*9.81, curved_plate_50mm_data.pressure_reading_1, 15, 'o', 'MarkerEdgeColor', '#0072BD')
...
scatter(flat_plate_20mm_data.weight_reading_1/1000*9.81, flat_plate_20mm_data.pressure_reading_1, 15, '^', 'MarkerEdgeColor', '#77AC30')
hold on
scatter(flat_plate_30mm_data.weight_reading_1/1000*9.81, flat_plate_30mm_data.pressure_reading_1, 15, '^', 'MarkerEdgeColor', '#EDB120')
hold on
scatter(flat_plate_40mm_data.weight_reading_1/1000*9.81, flat_plate_40mm_data.pressure_reading_1, 15, '^', 'MarkerEdgeColor', '#D95319')
hold on
scatter(flat_plate_50mm_data.weight_reading_1/1000*9.81, flat_plate_50mm_data.pressure_reading_1, 15, '^', 'MarkerEdgeColor', '#0072BD')
hold on
